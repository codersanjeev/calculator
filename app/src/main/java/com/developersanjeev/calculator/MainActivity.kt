    ...
    private val buttonClickListener = View.OnClickListener { view ->
        when(view.id){
            ...
            R.id.button_one -> {
                ...
                if(str == "0") display_view.text = "1"
                else display_view.text = str + "1"
            }

            // Button two is clicked
            R.id.button_two -> {
                val str:String = display_view.text.toString()
                if(str == "0") display_view.text = "2"
                else display_view.text = str + "2"
            }

            // Button three is clicked
            R.id.button_three -> {
                val str:String = display_view.text.toString()
                if(str == "0") display_view.text = "3"
                else display_view.text = str + "3"
            }

            // Button four is clicked
            R.id.button_four -> {
                val str:String = display_view.text.toString()
                if(str == "0") display_view.text = "4"
                else display_view.text = str + "4"
            }

            // Button five is clicked
            R.id.button_five -> {
                val str:String = display_view.text.toString()
                if(str == "0") display_view.text = "5"
                else display_view.text = str + "5"
            }

            // Button six is clicked
            R.id.button_six -> {
                val str:String = display_view.text.toString()
                if(str == "0") display_view.text = "6"
                else display_view.text = str + "6"
            }

            // Button seven is clicked
            R.id.button_seven -> {
                val str:String = display_view.text.toString()
                if(str == "0") display_view.text = "7"
                else display_view.text = str + "7"
            }

            // Button eight is clicked
            R.id.button_eight -> {
                val str:String = display_view.text.toString()
                if(str == "0") display_view.text = "8"
                else display_view.text = str + "8"
            }

            // Button nine is clicked
            R.id.button_nine -> {
                val str:String = display_view.text.toString()
                if(str == "0") display_view.text = "9"
                else display_view.text = str + "9"
            }

            // Button zero is clicked
            R.id.button_zero -> {
                val str:String = display_view.text.toString()
                if(str == "0") display_view.text = "0"
                else display_view.text = str + "0"
            }

            // Button clear is clicked
            R.id.button_clear -> display_view.text = "0"

            // Button plus is clicked
            R.id.button_plus -> {
                val str:String = display_view.text.toString()
                // checks if there is already an operator in the end
                if(ExpressionEvaluator.checkValidity(str)) display_view.text = str + "+"
            }
            ...
            R.id.button_multiply -> {
                val str:String = display_view.text.toString()
                if(ExpressionEvaluator.checkValidity(str)) display_view.text = str + "x"
            }
            ...
            R.id.button_change_sign -> {
                val str:String = display_view.text.toString()
                if(ExpressionEvaluator.checkValidity(str)) try {
            ...
            R.id.button_dot -> {
                ...
                if(!(str.endsWith("+") || str.endsWith("-")
                                || str.endsWith("x") || str.endsWith("/") || str.endsWith("."))) display_view.text = str + "."
            }
